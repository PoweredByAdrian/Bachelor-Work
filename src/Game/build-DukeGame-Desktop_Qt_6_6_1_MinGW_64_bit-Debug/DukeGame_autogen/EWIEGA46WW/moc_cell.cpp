...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCellENDCLASS_t qt_meta_stringdata_CLASSCellENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 18),  // "figureStateChanged"
        QT_MOC_LITERAL(24, 0)   // ""
    },
    "Cell",
    "figureStateChanged",
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->figureStateChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (Cell::*)();
            if (_t _q_method = &Cell::figureStateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
